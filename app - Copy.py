...
user_assigned_identity_client_id = '98cfd9c1-eb60-46b2-999a-80cdae76b39e'

# Initialize the Azure Key Vault SecretClient
key_vault_name = "nbh-keyvault"
kv_uri = f"https://nbh-keyvault.vault.azure.net/"
...
# Server=nbhsqlserver.database.windows.net;Database=nbhDB;Uid=paeuser;ColumnEncryption=Enabled;Encrypt=yes;TrustServerCertificate=yes;KeyStoreAuthentication=KeyVaultClientSecret;KeyStorePrincipalId={app reg client};KeyStoreSecret={app reg secret value};
